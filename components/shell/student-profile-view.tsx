        ...
        <section id="risk-profile" className="scroll-mt-24 flex flex-col gap-3">
          ...
          {risk.narrative.ok ? (
            <div className="rounded-2xl border border-sky-200 bg-sky-50 p-4">
              <div className="flex flex-wrap items-baseline justify-between gap-2">
                <p className="text-[10px] font-semibold uppercase tracking-[0.18em] text-sky-700">
                  AI narrative {risk.narrative.cached ? "(cached)" : "(fresh)"}
                </p>
            ...
            <div className="rounded-2xl border border-dashed border-slate-200 bg-slate-50 px-4 py-3">
              <div className="flex flex-wrap items-baseline justify-between gap-2">
                <p className="text-xs text-slate-500">{fallbackMessage(risk.narrative.reason)}</p>
                {/* Only "no_key" + "consent_revoked" don't benefit from a retry;
                    the others (quota/network/empty) might. */}
